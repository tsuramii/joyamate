...
function HeroSection() {
  ...
  return (
    <section id="hero" className="hero min-h-screen bg-center bg-cover bg-fixed bg-black/50" style={{ backgroundImage: `url("${heroImageURL}")` }}>
      ...
      <div className="hero-content text-center text-white">
        <div className="max-w-2xl">
          ...
          <a href="#productos"><button className="btn btn-primary btn-sm md:btn-md">Quiero lo mejor</button></a>
        </div>
      </div>
    </section>
  );
